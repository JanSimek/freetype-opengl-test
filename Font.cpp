...
Glyph Font::getGlyph( char32_t letter ) //const char* letter)
{
	FT_UInt  glyph_index;
	Glyph glyph;
	bool error;
	...
	std::string result = converter.to_bytes(letter);
	...
	glyph_index = FT_Get_Char_Index( face, letter ); // Q_UTF8_CodePoint(letter)); //282 );
